...
In the following graph, I wanted to visualize the relationship between the age and the reign duration of each emperor.
...
emperors %>%
  ...
  labs(subtitle = str_wrap("Colored bars represent the lifespan whereas the black bars the reign duration", 60)) +
